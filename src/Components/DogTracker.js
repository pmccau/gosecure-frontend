    ...
    return (
      <div>
        ...
        >
          <div>
            <table><tbody><tr>
              <td className="widgetMainText-time">&nbsp;&nbsp;{ this.getLastMovement(1) }&nbsp;&nbsp;</td>
              <td className="widgetMainText-time">&nbsp;&nbsp;{ this.getLastMovement(2) }&nbsp;&nbsp;</td>
            </tr><tr>
              <td><div onClick={ () => this.logMovement(1) } className="sensorButton false">
                <div className="sensorButtonText">pee</div>
              </div></td>
              <td><div onClick={ () => this.logMovement(2) } className="sensorButton false">
                <div className="sensorButtonText">poo</div>
              </div></td>
            </tr><tr><td colSpan="2">
              <div onClick={ () => this.logMovement(3) } className="sensorButton false">
                <div className="sensorButtonText">both</div>
              </div>
            </td></tr><tr><td>
